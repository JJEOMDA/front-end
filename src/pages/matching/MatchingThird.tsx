...
const MatchingThird = (props: {
  ...
  return (
    <PostForm onSubmit={handleSubmit(onSubmit)} viewInput={viewInput}>
      <Line>
        <label htmlFor="mbti">이성의 MBTI</label>
        <Input
          id="mbti"
          type="text"
          autoComplete="off"
          placeholder="MBTI를 입력해주세요 (상관없음, ISFP)"
      ...
      <Line className="job">
        <label htmlFor="job">이성의 직업</label>
        <Input
          id="job"
          type="text"
          autoComplete="off"
      ...
      <Line className="hobby">
        <label htmlFor="hobby">이성의 취미/특기</label>
        <Input
          id="hobby"
          type="text"
          autoComplete="off"
      ...
      <Line className="appearance">
        <label htmlFor="appearance">이성의 외모를 동물로 비유하자면?</label>
        <Input
          id="appearance"
          type="text"
          autoComplete="off"
